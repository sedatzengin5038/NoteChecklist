...
class CommonTextFieldChecklist extends StatelessWidget {
  const CommonTextFieldChecklist({
    Key? key,
  ...
  Widget build(BuildContext context) {
    return Material(
      ...
      child: TextField(
        ...
        readOnly: context.read<StatusIconsCubitChecklist>().state is ReadOnlyStateChecklist,
      ),
    );
  }
