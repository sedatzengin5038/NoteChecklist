...
class IconPinnedStatus extends StatelessWidget {
  ...
  IconData iconCurrentStatus(StateNote currentStatus) {
    return currentStatus == StateNote.pinned ? AppIcons.pin : AppIcons.unPin;
  }

  void _onTogglePinnedStatus(BuildContext context, StateNote currentStatus) {
    return context
